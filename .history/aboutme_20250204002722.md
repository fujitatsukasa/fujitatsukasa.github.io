...
<script>
  ...
  if (indicatorsContainer) {
    ...
    indicatorsWrapper.classList.add('carousel-indicators-container');
    indicatorsWrapper.style.textAlign = 'center';
    indicatorsWrapper.style.marginTop = '1em';
    const newIndicatorsContainer = document.createElement('div');
    newIndicatorsContainer.classList.add('carousel-indicators');
    indicatorsWrapper.appendChild(newIndicatorsContainer);
    document.querySelector('.carousel').insertAdjacentElement('afterend', indicatorsWrapper);
  }

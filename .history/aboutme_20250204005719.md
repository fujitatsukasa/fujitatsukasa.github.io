...
<div class="page-content">
  ...
  <!-- 既存のセクション（特徴、詳細機能、使い方の流れなど）はそのまま -->
...
<script>
  ...
  // Create carousel indicators below the carousel
  ...
  // Append indicators just below the carousel container
  const carouselElement = document.querySelector('.carousel');
  carouselElement.parentNode.insertBefore(indicatorsContainer, carouselElement.nextSibling);
  ...
  // Arrow buttons (we already inserted them in HTML? If not, create them)
  ...
  if (!leftArrow || !rightArrow) {
    const newLeftArrow = document.createElement('button');
    newLeftArrow.className = 'carousel-button carousel-button--left';
    newLeftArrow.innerHTML = '&#10094;';
    const newRightArrow = document.createElement('button');
    newRightArrow.className = 'carousel-button carousel-button--right';
    newRightArrow.innerHTML = '&#10095;';
    carouselElement.appendChild(newLeftArrow);
    carouselElement.appendChild(newRightArrow);
  }
